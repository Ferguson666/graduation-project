...
class ChannelAttention(nn.Module):
    def __init__(self ):
        ...
        self.avg_pool = nn.AdaptiveAvgPool2d((2,512))
        self.max_pool = nn.AdaptiveMaxPool2d((2,512))

        self.fc1 = nn.Conv2d(2,2,1, bias=False)
        self.relu1 = nn.ReLU()
        self.fc2 = nn.Conv2d(2,2,1, bias=False)
