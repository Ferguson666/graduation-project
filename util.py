...
class DATA_LOADER(object):
    ...
    def read_matdataset(self, opt):
        ...
        label = matcontent['lable'].T.astype(int).squeeze() - 1
        ...
        if not opt.validation:
            ...
            self.train_feature = netA( self.self.train_feature.reshape(1213,2,2,512))
            self.train_feature = self.self.train_feature.reshape(1213,2048)
